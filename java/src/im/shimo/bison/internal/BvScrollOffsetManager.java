 ...
 */
@VisibleForTesting
public class BvScrollOffsetManager {
    ...
    /**
     * The interface that all users of BvScrollOffsetManager should implement.
     *
    ...
    public BvScrollOffsetManager(Delegate delegate) {
        mDelegate = delegate;
    }
