 ...
 */
public final class BvGeolocationPermissions {
    ...
    public BvGeolocationPermissions(SharedPreferences sharedPreferences) {
    ...
    static void migrateGeolocationPreferences(
        ...
        for (String name : oldPrefs.getAll().keySet()) {
            if (name.startsWith(BvGeolocationPermissions.PREF_PREFIX)) {
