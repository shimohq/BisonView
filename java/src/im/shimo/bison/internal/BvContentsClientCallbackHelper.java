...
class BvContentsClientCallbackHelper {
    /**
     * Interface to tell CallbackHelper to cancel posted callbacks.
     */
    interface CancelCallbackPoller { boolean shouldCancelAllCallbacks(); }

    // MessageLoop to post directly to BisonContents.
    ...
    private static class OnReceivedErrorInfo {
        final BvWebResourceRequest mRequest;
        final BvContentsClient.BvWebResourceError mError;

        OnReceivedErrorInfo(BvWebResourceRequest request,
                            BvContentsClient.BvWebResourceError error) {
            mRequest = request;
            mError = error;
        }
    }
    ...
    private static class OnReceivedHttpErrorInfo {
        final BvWebResourceRequest mRequest;
        final BvWebResourceResponse mResponse;

        OnReceivedHttpErrorInfo(
                BvWebResourceRequest request, BvWebResourceResponse response) {
            mRequest = request;
            mResponse = response;
        }
    }
            ...
            switch(msg.what) {
                ...
                default:
                    throw new IllegalStateException(
                            "BisonContentsClientCallbackHelper: unhandled message " + msg.what);
            }
        }
    }

    public BvContentsClientCallbackHelper(Looper looper, BvContentsClient contentsClient) {
    ...
    public void postOnReceivedError(BvWebResourceRequest request,
                                    BvContentsClient.BvWebResourceError error) {
    ...
    public void postOnReceivedHttpError(BvWebResourceRequest request,
