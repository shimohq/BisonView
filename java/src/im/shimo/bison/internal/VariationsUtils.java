...
import im.shimo.bison.internal.BvVariationsSeedOuterClass.BvVariationsSeed;
...
public class VariationsUtils {
    ...
    public static SeedInfo readSeedFile(File inFile) {
        ...
        try {
            ...
            BvVariationsSeed proto = null;
            try {
                proto = BvVariationsSeed.parseFrom(in);
    ...
    public static boolean writeSeed(FileOutputStream out, SeedInfo info) {
        try {
            BvVariationsSeed proto = BvVariationsSeed.newBuilder()
