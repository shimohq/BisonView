...
#ifndef BISON_ANDROID_RENDERER_BISON_WEBSOCKET_HANDSHAKE_THROTTLE_PROVIDER_H_
#define BISON_ANDROID_RENDERER_BISON_WEBSOCKET_HANDSHAKE_THROTTLE_PROVIDER_H_
...
class BisonWebSocketHandshakeThrottleProvider final
    : public content::WebSocketHandshakeThrottleProvider {
 public:
  explicit BisonWebSocketHandshakeThrottleProvider(
      blink::ThreadSafeBrowserInterfaceBrokerProxy* broker);
  ~BisonWebSocketHandshakeThrottleProvider() override;
 ...
 private:
  ...
  // general use.
  BisonWebSocketHandshakeThrottleProvider(
  ...
  DISALLOW_ASSIGN(BisonWebSocketHandshakeThrottleProvider);
};

}  // namespace bison

#endif  // BISON_ANDROID_RENDERER_BISON_WEBSOCKET_HANDSHAKE_THROTTLE_PROVIDER_H_
