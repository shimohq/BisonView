...
#include "bison/android/renderer/bison_render_view_ext.h"
...
BisonRenderViewExt::BisonRenderViewExt(content::RenderView* render_view)
    : content::RenderViewObserver(render_view) {
  DCHECK(render_view != nullptr);
}

BisonRenderViewExt::~BisonRenderViewExt() {}

// static
void BisonRenderViewExt::RenderViewCreated(content::RenderView* render_view) {
  new BisonRenderViewExt(render_view);  // |render_view| takes ownership.
}

void BisonRenderViewExt::DidCommitCompositorFrame() {
  UpdateContentsSize();
}

void BisonRenderViewExt::DidUpdateMainFrameLayout() {
  // The size may have changed.
  needs_contents_size_update_ = true;
}

void BisonRenderViewExt::OnDestruct() {
  delete this;
}

void BisonRenderViewExt::UpdateContentsSize() {
