...
#ifndef BISON_ANDROID_RENDERER_BISON_RENDER_THREAD_OBSERVER_H_
#define BISON_ANDROID_RENDERER_BISON_RENDER_THREAD_OBSERVER_H_
...
#endif  // BISON_ANDROID_RENDERER_BISON_RENDER_THREAD_OBSERVER_H_
