...
#ifndef BISON_ANDROID_RENDERER_BISON_PRINT_RENDER_FRAME_HELPER_DELEGATE_H_
#define BISON_ANDROID_RENDERER_BISON_PRINT_RENDER_FRAME_HELPER_DELEGATE_H_
...
#endif  // BISON_ANDROID_RENDERER_BISON_PRINT_RENDER_FRAME_HELPER_DELEGATE_H_
