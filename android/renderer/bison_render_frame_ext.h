...
#ifndef BISON_ANDROID_RENDERER_BISON_RENDER_FRAME_EXT_H_
#define BISON_ANDROID_RENDERER_BISON_RENDER_FRAME_EXT_H_
...
#endif  // BISON_ANDROID_RENDERER_BISON_RENDER_FRAME_EXT_H_
