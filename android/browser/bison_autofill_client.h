...
#ifndef BISON_ANDROID_BROWSER_BISON_AUTOFILL_CLIENT_H_
#define BISON_ANDROID_BROWSER_BISON_AUTOFILL_CLIENT_H_
...
// the delegates.
class BisonAutofillClient : public autofill::AutofillClient,
                         public content::WebContentsUserData<BisonAutofillClient> {
 public:
  ~BisonAutofillClient() override;
 ...
 private:
  explicit BisonAutofillClient(content::WebContents* web_contents);
  friend class content::WebContentsUserData<BisonAutofillClient>;
  ...
  DISALLOW_COPY_AND_ASSIGN(BisonAutofillClient);
};

}  // namespace bison

#endif  // BISON_ANDROID_BROWSER_BISON_AUTOFILL_CLIENT_H_
