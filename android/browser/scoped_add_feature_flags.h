...
#ifndef BISON_ANDROID_BROWSER_SCOPED_ADD_FEATURE_FLAGS_H_
#define BISON_ANDROID_BROWSER_SCOPED_ADD_FEATURE_FLAGS_H_
...
#endif  // BISON_ANDROID_BROWSER_SCOPED_ADD_FEATURE_FLAGS_H_
