...
#ifndef BISON_ANDROID_BROWSER_BISON_QUOTA_MANAGER_BRIDGE_H_
#define BISON_ANDROID_BROWSER_BISON_QUOTA_MANAGER_BRIDGE_H_
...
#endif  // BISON_ANDROID_BROWSER_BISON_QUOTA_MANAGER_BRIDGE_H_
