...
#ifndef BISON_ANDROID_BROWSER_TRACING_BISON_TRACING_DELEGATE_H_
#define BISON_ANDROID_BROWSER_TRACING_BISON_TRACING_DELEGATE_H_
...
#endif  // BISON_ANDROID_BROWSER_TRACING_BISON_TRACING_DELEGATE_H_
