...
#ifndef BISON_ANDROID_BROWSER_BISON_QUOTA_PERMISSION_CONTEXT_H_
#define BISON_ANDROID_BROWSER_BISON_QUOTA_PERMISSION_CONTEXT_H_
...
#endif  // BISON_ANDROID_BROWSER_BISON_QUOTA_PERMISSION_CONTEXT_H_
