...
#ifndef BISON_ANDROID_BROWSER_POPUP_TOUCH_HANDLE_DRAWABLE_H_
#define BISON_ANDROID_BROWSER_POPUP_TOUCH_HANDLE_DRAWABLE_H_
...
#endif  // BISON_ANDROID_BROWSER_POPUP_TOUCH_HANDLE_DRAWABLE_H_
