...
#ifndef BISON_ANDROID_BROWSER_BISON_DOWNLOAD_MANAGER_DELEGATE_H_
#define BISON_ANDROID_BROWSER_BISON_DOWNLOAD_MANAGER_DELEGATE_H_
...
#endif  // BISON_ANDROID_BROWSER_BISON_DOWNLOAD_MANAGER_DELEGATE_H_
