...
#ifndef BISON_ANDROID_BROWSER_NETWORK_SERVICE_BISON_PROXY_CONFIG_MONITOR_H_
#define BISON_ANDROID_BROWSER_NETWORK_SERVICE_BISON_PROXY_CONFIG_MONITOR_H_
...
#endif  // BISON_ANDROID_BROWSER_NETWORK_SERVICE_BISON_PROXY_CONFIG_MONITOR_H_
