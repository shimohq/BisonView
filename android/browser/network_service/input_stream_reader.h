...
#ifndef BISON_ANDROID_BROWSER_NETWORK_SERVICE_INPUT_STREAM_READER_H_
#define BISON_ANDROID_BROWSER_NETWORK_SERVICE_INPUT_STREAM_READER_H_
...
#endif  // BISON_ANDROID_BROWSER_NETWORK_SERVICE_INPUT_STREAM_READER_H_
