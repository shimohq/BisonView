...
#ifndef BISON_ANDROID_BROWSER_NETWORK_SERVICE_BISON_URL_LOADER_THROTTLE_H_
#define BISON_ANDROID_BROWSER_NETWORK_SERVICE_BISON_URL_LOADER_THROTTLE_H_
...
#endif  // BISON_ANDROID_BROWSER_NETWORK_SERVICE_BISON_URL_LOADER_THROTTLE_H_
