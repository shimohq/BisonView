...
BisonWebResourceRequest::BisonWebResourceRequest(BisonWebResourceRequest&& other) =
    default;
...
BisonWebResourceRequest::BisonJavaWebResourceRequest::BisonJavaWebResourceRequest() =
    default;
BisonWebResourceRequest::BisonJavaWebResourceRequest::~BisonJavaWebResourceRequest() =
    default;

// static
void BisonWebResourceRequest::ConvertToJava(JNIEnv* env,
