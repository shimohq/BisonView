...
#include "bison/android/test/bison_unittests_jni/MockBisonContentsClientBridge_jni.h"
...
// Tests the bison contents client bridge.
class BisonContentsClientBridgeTest : public Test {
 public:
  BisonContentsClientBridgeTest() {}
 ...
 protected:
  ...
  std::unique_ptr<BisonContentsClientBridge> bridge_;
...
class TestClientCertificateDelegate
 ...
 public:
  explicit TestClientCertificateDelegate(BisonContentsClientBridgeTest* test)
      : test_(test) {}
 ...
 private:
  BisonContentsClientBridgeTest* test_;
...
void BisonContentsClientBridgeTest::SetUp() {
  env_ = AttachCurrentThread();
  ASSERT_THAT(env_, NotNull());
  jbridge_.Reset(
      env_,
      Java_MockBisonContentsClientBridge_getBisonContentsClientBridge(env_).obj());
  bridge_.reset(new BisonContentsClientBridge(env_, jbridge_));
  selected_cert_ = nullptr;
  cert_selected_callbacks_ = 0;
  cert_request_info_ = base::MakeRefCounted<net::SSLCertRequestInfo>();
}

void BisonContentsClientBridgeTest::CertSelected(
...
TEST_F(BisonContentsClientBridgeTest, TestClientCertKeyTypesCorrectlyEncoded) {
...
void BisonContentsClientBridgeTest::TestCertType(
  ...
  ScopedJavaLocalRef<jobjectArray> key_types =
      Java_MockBisonContentsClientBridge_getKeyTypes(env_, jbridge_);
...
TEST_F(BisonContentsClientBridgeTest,
  ...
  bridge_->ProvideClientCertificateResponse(
      env_, jbridge_,
      Java_MockBisonContentsClientBridge_getRequestId(env_, jbridge_),
      Java_MockBisonContentsClientBridge_createTestCertChain(env_, jbridge_),
      nullptr);
  base::RunLoop().RunUntilIdle();
...
TEST_F(BisonContentsClientBridgeTest,
  ...
  bridge_->SelectClientCertificate(
      cert_request_info_.get(),
      base::WrapUnique(new TestClientCertificateDelegate(this)));
  int requestId = Java_MockBisonContentsClientBridge_getRequestId(env_, jbridge_);
