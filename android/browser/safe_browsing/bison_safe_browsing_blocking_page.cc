...
BisonSafeBrowsingBlockingPage::BisonSafeBrowsingBlockingPage(
  ...
  if (unsafe_resources.size() == 1 &&
    ...
    threat_details_in_progress_ =
        BisonBrowserProcess::GetInstance()
...
// static
void BisonSafeBrowsingBlockingPage::ShowBlockingPage(
    BisonSafeBrowsingUIManager* ui_manager,
  ...
  if (InterstitialPage::GetInterstitialPage(web_contents) &&
    ...
    BisonSafeBrowsingBlockingPage* blocking_page = new BisonSafeBrowsingBlockingPage(
...
void BisonSafeBrowsingBlockingPage::FinishThreatDetails(
  ...
  // to send the report.
  bool report_sent = BisonBrowserProcess::GetInstance()
                         ->GetSafeBrowsingTriggerManager()
