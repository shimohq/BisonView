...
#ifndef BISON_ANDROID_BROWSER_SAFE_BROWSING_BISON_SAFE_BROWSING_WHITELIST_MANAGER_H_
#define BISON_ANDROID_BROWSER_SAFE_BROWSING_BISON_SAFE_BROWSING_WHITELIST_MANAGER_H_
...
class BisonSafeBrowsingWhitelistManager {
 public:
  ...
  virtual ~BisonSafeBrowsingWhitelistManager();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BisonSafeBrowsingWhitelistManager);
};

}  // namespace bison

#endif  // BISON_ANDROID_BROWSER_SAFE_BROWSING_BISON_SAFE_BROWSING_WHITELIST_MANAGER_H_
