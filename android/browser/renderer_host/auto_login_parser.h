...
#ifndef BISON_ANDROID_BROWSER_RENDERER_HOST_AUTO_LOGIN_PARSER_H_
#define BISON_ANDROID_BROWSER_RENDERER_HOST_AUTO_LOGIN_PARSER_H_
...
#endif  // BISON_ANDROID_BROWSER_RENDERER_HOST_AUTO_LOGIN_PARSER_H_
