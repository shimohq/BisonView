...
#ifndef BISON_ANDROID_BROWSER_METRICS_MEMORY_METRICS_LOGGER_H_
#define BISON_ANDROID_BROWSER_METRICS_MEMORY_METRICS_LOGGER_H_
...
#endif  // BISON_ANDROID_BROWSER_METRICS_MEMORY_METRICS_LOGGER_H_
