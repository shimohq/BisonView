...
#ifndef BISON_ANDROID_BROWSER_METRICS_BISON_METRICS_LOG_UPLOADER_H_
#define BISON_ANDROID_BROWSER_METRICS_BISON_METRICS_LOG_UPLOADER_H_
...
#endif  // BISON_ANDROID_BROWSER_METRICS_BISON_METRICS_LOG_UPLOADER_H_
