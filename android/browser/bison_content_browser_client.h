...
#ifndef BISON_ANDROID_BROWSER_BISON_CONTENT_BISON_ANDROID_BROWSER_CLIENT_H_
#define BISON_ANDROID_BROWSER_BISON_CONTENT_BISON_ANDROID_BROWSER_CLIENT_H_
...
class BisonContentBrowserClient : public content::ContentBrowserClient {
 public:
  // This is what BisonContentBrowserClient::GetAcceptLangs uses.
  ...
  // Allows BisonBrowserMainParts to initialize a BrowserContext at the right
  // moment during startup. BisonContentBrowserClient owns the result.
 ...
 private:
  ...
  BisonFeatureListCreator* const aw_feature_list_creator_;
...
#endif  // BISON_ANDROID_BROWSER_BISON_CONTENT_BISON_ANDROID_BROWSER_CLIENT_H_
