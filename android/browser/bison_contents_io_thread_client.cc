...
#include "bison/android/browser/network_service/bison_web_resource_intercept_response.h"
#include "bison/android/browser/network_service/bison_web_resource_request.h"
#include "bison/android/browser/network_service/bison_web_resource_response.h"
#include "bison/android/browser_jni_headers/BisonContentsBackgroundThreadClient_jni.h"
#include "bison/android/browser_jni_headers/BisonContentsIoThreadClient_jni.h"
...
// static
std::unique_ptr<BisonContentsIoThreadClient> BisonContentsIoThreadClient::FromID(
  ...
  return std::make_unique<BisonContentsIoThreadClient>(
...
// static
void BisonContentsIoThreadClient::SubFrameCreated(int render_process_id,
...
// static
void BisonContentsIoThreadClient::RegisterPendingContents(
    WebContents* web_contents) {
  IoThreadClientData client_data;
...
// static
void BisonContentsIoThreadClient::Associate(WebContents* web_contents,
...
// static
void BisonContentsIoThreadClient::SetServiceWorkerIoThreadClient(
...
BisonContentsIoThreadClient::GetServiceWorkerIoThreadClient() {
  JNIEnv* env = AttachCurrentThread();
  ...
  return std::make_unique<BisonContentsIoThreadClient>(false, java_delegate);
}

BisonContentsIoThreadClient::BisonContentsIoThreadClient(bool pending_association,
...
BisonContentsIoThreadClient::CacheMode BisonContentsIoThreadClient::GetCacheMode()
    const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return BisonContentsIoThreadClient::LOAD_DEFAULT;

  JNIEnv* env = AttachCurrentThread();
  return static_cast<BisonContentsIoThreadClient::CacheMode>(
      Java_BisonContentsIoThreadClient_getCacheMode(env, java_object_));
}
...
void RecordResponseStatusCode(
    JNIEnv* env,
    const std::unique_ptr<BisonWebResourceResponse>& response) {
  DCHECK(response);
...
std::unique_ptr<BisonWebResourceInterceptResponse> NoInterceptRequest() {
  return nullptr;
}

std::unique_ptr<BisonWebResourceInterceptResponse> RunShouldInterceptRequest(
  ...
  ScopedJavaLocalRef<jobject> ret =
      Java_BisonContentsBackgroundThreadClient_shouldInterceptRequestFromNative(
  ...
  auto response = std::make_unique<BisonWebResourceInterceptResponse>(ret);
...
void BisonContentsIoThreadClient::ShouldInterceptRequestAsync(
  ...
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  base::OnceCallback<std::unique_ptr<BisonWebResourceInterceptResponse>()>
  ...
  if (bg_thread_client_object_.is_null() && !java_object_.is_null()) {
    bg_thread_client_object_.Reset(
        Java_BisonContentsIoThreadClient_getBackgroundThreadClient(env,
                                                                java_object_));
  }
...
bool BisonContentsIoThreadClient::ShouldBlockContentUrls() const {
  ...
  JNIEnv* env = AttachCurrentThread();
  return Java_BisonContentsIoThreadClient_shouldBlockContentUrls(env,
                                                              java_object_);
}

bool BisonContentsIoThreadClient::ShouldBlockFileUrls() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BisonContentsIoThreadClient_shouldBlockFileUrls(env, java_object_);
}

bool BisonContentsIoThreadClient::ShouldAcceptThirdPartyCookies() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BisonContentsIoThreadClient_shouldAcceptThirdPartyCookies(
      env, java_object_);
}

bool BisonContentsIoThreadClient::GetSafeBrowsingEnabled() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BisonContentsIoThreadClient_getSafeBrowsingEnabled(env,
                                                              java_object_);
}

bool BisonContentsIoThreadClient::ShouldBlockNetworkLoads() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BisonContentsIoThreadClient_shouldBlockNetworkLoads(env,
                                                               java_object_);
}
