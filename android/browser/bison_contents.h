...
#ifndef BISON_ANDROID_BROWSER_BISON_CONTENTS_H_
#define BISON_ANDROID_BROWSER_BISON_CONTENTS_H_
...
#include "bison/android/browser/bison_render_process_gone_delegate.h"
#include "bison/android/browser/find_helper.h"
#include "bison/android/browser/gfx/browser_view_renderer.h"
#include "bison/android/browser/gfx/browser_view_renderer_client.h"
#include "bison/android/browser/icon_helper.h"
#include "bison/android/browser/js_java_interaction/js_java_configurator_host.h"
#include "bison/android/browser/permission/permission_request_handler_client.h"
#include "bison/android/browser/renderer_host/bison_render_view_host_ext.h"
#include "bison/android/browser/safe_browsing/bison_safe_browsing_ui_manager.h"
...
class BisonContents : public FindHelper::Listener,
                   ...
                   public BisonSafeBrowsingUIManager::UIManagerClient {
 public:
  // Returns the BisonContents instance associated with |web_contents|, or NULL.
  static BisonContents* FromWebContents(content::WebContents* web_contents);

  static std::string GetLocale();

  static std::string GetLocaleList();

  BisonContents(std::unique_ptr<content::WebContents> web_contents);
  ...
  // org.chromium.bison.BisonHttpAuthHandler.
  ...
  jlong ReleasePopupBisonContents(JNIEnv* env,
                               const base::android::JavaParamRef<jobject>& obj);
  ...
  void SetBisonAutofillClient(const base::android::JavaRef<jobject>& client);
  ...
  // BisonSafeBrowsingUIManager::UIManagerClient implementation
 ...
 private:
  ...
  std::unique_ptr<BisonContents> pending_contents_;
...
#endif  // BISON_ANDROID_BROWSER_BISON_CONTENTS_H_
