...
#include "bison/android/browser/gfx/surfaces_instance.h"

#include <algorithm>
#include <memory>
#include <utility>

#include "bison/android/browser/gfx/bison_render_thread_context_provider.h"
#include "bison/android/browser/gfx/bison_vulkan_context_provider.h"
#include "bison/android/browser/gfx/deferred_gpu_command_service.h"
#include "bison/android/browser/gfx/gpu_service_web_view.h"
#include "bison/android/browser/gfx/parent_output_surface.h"
#include "bison/android/browser/gfx/skia_output_surface_dependency_webview.h"
#include "bison/android/browser/gfx/task_queue_web_view.h"
...
SurfacesInstance::SurfacesInstance()
  ...
  auto vulkan_context_provider =
      enable_vulkan ? BisonVulkanContextProvider::GetOrCreateInstance() : nullptr;
  std::unique_ptr<viz::OutputSurface> output_surface;
  gl_surface_ = base::MakeRefCounted<BisonGLSurface>();
  if (settings.use_skia_renderer) {
    ...
    auto context_provider = BisonRenderThreadContextProvider::Create(
