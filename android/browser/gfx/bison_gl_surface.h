...
#ifndef BISON_ANDROID_BROWSER_GFX_BISON_GL_SURFACE_H_
#define BISON_ANDROID_BROWSER_GFX_BISON_GL_SURFACE_H_
...
// GLSurface.
class BisonGLSurface : public gl::GLSurface {
 public:
  BisonGLSurface();
 ...
 protected:
  ~BisonGLSurface() override;

 private:
  PresentationCallback pending_presentation_callback_;
  gfx::Size size_;
  DISALLOW_COPY_AND_ASSIGN(BisonGLSurface);
};

}  // namespace bison

#endif  // BISON_ANDROID_BROWSER_GFX_BISON_GL_SURFACE_H_
