...
#ifndef BISON_ANDROID_BROWSER_GFX_TASK_FORWARDING_SEQUENCE_H_
#define BISON_ANDROID_BROWSER_GFX_TASK_FORWARDING_SEQUENCE_H_
...
#endif  // BISON_ANDROID_BROWSER_GFX_TASK_FORWARDING_SEQUENCE_H_
