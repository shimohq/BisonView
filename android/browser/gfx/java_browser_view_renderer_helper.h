...
#ifndef BISON_ANDROID_BROWSER_GFX_JAVA_BROWSER_VIEW_RENDERER_HELPER_H_
#define BISON_ANDROID_BROWSER_GFX_JAVA_BROWSER_VIEW_RENDERER_HELPER_H_
...
#endif  // BISON_ANDROID_BROWSER_GFX_JAVA_BROWSER_VIEW_RENDERER_HELPER_H_
