...
#ifndef BISON_ANDROID_BROWSER_GFX_HARDWARE_RENDERER_H_
#define BISON_ANDROID_BROWSER_GFX_HARDWARE_RENDERER_H_
...
#endif  // BISON_ANDROID_BROWSER_GFX_HARDWARE_RENDERER_H_
