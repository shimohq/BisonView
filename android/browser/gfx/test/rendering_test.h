...
#ifndef BISON_ANDROID_BROWSER_GFX_TEST_RENDERING_TEST_H_
#define BISON_ANDROID_BROWSER_GFX_TEST_RENDERING_TEST_H_

#include <memory>

#include "bison/android/browser/gfx/browser_view_renderer_client.h"
#include "bison/android/browser/gfx/test/fake_window.h"
...
#endif  // BISON_ANDROID_BROWSER_GFX_TEST_RENDERING_TEST_H_
