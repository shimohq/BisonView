...
#ifndef BISON_ANDROID_BROWSER_GFX_COMPOSITOR_FRAME_PRODUCER_H_
#define BISON_ANDROID_BROWSER_GFX_COMPOSITOR_FRAME_PRODUCER_H_
...
#endif  // BISON_ANDROID_BROWSER_GFX_COMPOSITOR_FRAME_PRODUCER_H_
