...
#ifndef BISON_ANDROID_BROWSER_GFX_RENDER_THREAD_MANAGER_H_
#define BISON_ANDROID_BROWSER_GFX_RENDER_THREAD_MANAGER_H_

#include <map>

#include "bison/android/browser/gfx/compositor_frame_consumer.h"
#include "bison/android/browser/gfx/hardware_renderer_single_thread.h"
...
#endif  // BISON_ANDROID_BROWSER_GFX_RENDER_THREAD_MANAGER_H_
