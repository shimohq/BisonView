...
#ifndef BISON_ANDROID_BROWSER_GFX_SCOPED_APP_GL_STATE_RESTORE_H_
#define BISON_ANDROID_BROWSER_GFX_SCOPED_APP_GL_STATE_RESTORE_H_
...
#endif  // BISON_ANDROID_BROWSER_GFX_SCOPED_APP_GL_STATE_RESTORE_H_
