...
#ifndef BISON_ANDROID_BROWSER_BISON_COOKIE_ACCESS_POLICY_H_
#define BISON_ANDROID_BROWSER_BISON_COOKIE_ACCESS_POLICY_H_
...
class BisonCookieAccessPolicy {
 public:
  static BisonCookieAccessPolicy* GetInstance();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BisonCookieAccessPolicy);
};

}  // namespace bison

#endif  // BISON_ANDROID_BROWSER_BISON_COOKIE_ACCESS_POLICY_H_
