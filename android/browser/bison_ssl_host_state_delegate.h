...
#ifndef BISON_ANDROID_BROWSER_BISON_SSL_HOST_STATE_DELEGATE_H_
#define BISON_ANDROID_BROWSER_BISON_SSL_HOST_STATE_DELEGATE_H_
...
class BisonSSLHostStateDelegate : public content::SSLHostStateDelegate {
 public:
  BisonSSLHostStateDelegate();
  ~BisonSSLHostStateDelegate() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BisonSSLHostStateDelegate);
};

}  // namespace bison

#endif  // BISON_ANDROID_BROWSER_BISON_SSL_HOST_STATE_DELEGATE_H_
