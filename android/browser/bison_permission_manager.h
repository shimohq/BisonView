...
#ifndef BISON_ANDROID_BROWSER_BISON_PERMISSION_MANAGER_H_
#define BISON_ANDROID_BROWSER_BISON_PERMISSION_MANAGER_H_
...
class BisonPermissionManager : public content::PermissionControllerDelegate {
 ...
 private:
  ...
  virtual BisonBrowserPermissionRequestDelegate* GetDelegate(int render_process_id,
                                                          int render_frame_id);
  ...
  base::WeakPtrFactory<BisonPermissionManager> weak_ptr_factory_{this};
...
#endif // BISON_ANDROID_BROWSER_BISON_PERMISSION_MANAGER_H_
