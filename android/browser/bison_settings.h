...
#ifndef BISON_ANDROID_BROWSER_BISON_SETTINGS_H_
#define BISON_ANDROID_BROWSER_BISON_SETTINGS_H_
...
class BisonSettings : public content::WebContentsObserver {
 public:
  ...
  // GENERATED_JAVA_ENUM_PACKAGE: im.shimo.bison.core.settings
  enum ForceDarkMode {
    FORCE_DARK_OFF = 0,
    FORCE_DARK_AUTO = 1,
    FORCE_DARK_ON = 2,
...
#endif  // BISON_ANDROID_BROWSER_BISON_SETTINGS_H_
