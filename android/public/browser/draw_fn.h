...
#ifndef BISON_ANDROID_PUBLIC_BROWSER_DRAW_FN_H_
#define BISON_ANDROID_PUBLIC_BROWSER_DRAW_FN_H_
...
// 2 Adds transfer_function_* and color_space_toXYZD50 to BisonDrawFn_DrawGLParams.
static const int kAwDrawFnVersion = 2;

struct BisonDrawFn_OnSyncParams {
  int version;

  bool apply_force_dark;
};

struct BisonDrawFn_DrawGLParams {
  int version;
...
struct BisonDrawFn_DrawVkParams {
  int version;
...
struct BisonDrawFn_PostDrawVkParams {
  int version;
};
...
typedef void AwDrawFn_OnSync(int functor,
                             void* data,
                             BisonDrawFn_OnSyncParams* params);
...
typedef void AwDrawFn_DrawGL(int functor,
                             void* data,
                             BisonDrawFn_DrawGLParams* params);
...
typedef void AwDrawFn_InitVk(int functor,
                             void* data,
                             BisonDrawFn_InitVkParams* params);
...
struct BisonDrawFnFunctorCallbacks {
...
struct BisonDrawFnFunctionTable {
  int version;
...
#endif  // BISON_ANDROID_PUBLIC_BROWSER_DRAW_FN_H_
