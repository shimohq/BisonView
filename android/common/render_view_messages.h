...
#ifndef BISON_ANDROID_COMMON_RENDER_VIEW_MESSAGES_H_
#define BISON_ANDROID_COMMON_RENDER_VIEW_MESSAGES_H_
...
#endif  // BISON_ANDROID_COMMON_RENDER_VIEW_MESSAGES_H_
