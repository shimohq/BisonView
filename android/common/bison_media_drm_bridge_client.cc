...
BisonMediaDrmBridgeClient::BisonMediaDrmBridgeClient(
    const std::vector<std::string>& key_system_uuid_mappings)
    : key_system_uuid_mappings_(key_system_uuid_mappings) {}

BisonMediaDrmBridgeClient::~BisonMediaDrmBridgeClient() {}

void BisonMediaDrmBridgeClient::AddKeySystemUUIDMappings(KeySystemUuidMap* map) {
...
BisonMediaDrmBridgeClient::GetMediaDrmBridgeDelegate(
