...
import im.shimo.bison.BisonSwitches;
 ...
 */
@JNINamespace("bison")
public class BisonSafeBrowsingConfigHelper {
    private static final String TAG = "BisonSafeBrowsingConfi-";
    ...
    public static void maybeEnableSafeBrowsingFromManifest(final Context appContext) {
        try (ScopedSysTraceEvent e = ScopedSysTraceEvent.scoped(
                     "BisonSafeBrowsingConfigHelper.maybeEnableSafeBrowsingFromManifest")) {
    ...
    private static boolean isDisabledByCommandLine() {
        try (ScopedSysTraceEvent e = ScopedSysTraceEvent.scoped(
                     "BisonSafeBrowsingConfigHelper.isDisabledByCommandLine")) {
            CommandLine cli = CommandLine.getInstance();
            // Disable flag has higher precedence than the default
            return cli.hasSwitch(BisonSwitches.WEBVIEW_DISABLE_SAFEBROWSING_SUPPORT);
        }
    }
    ...
    private static Boolean getAppOptInPreference(Context appContext) {
        try (ScopedSysTraceEvent e = ScopedSysTraceEvent.scoped(
                     "BisonSafeBrowsingConfigHelper.getAppOptInPreference")) {
    ...
    private BisonSafeBrowsingConfigHelper() {}
}
