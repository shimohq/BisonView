...
public class BisonAutofillManager {
    ...
    private static class AutofillInputUIMonitor extends AutofillManager.AutofillCallback {
        private WeakReference<BisonAutofillManager> mManager;

        public AutofillInputUIMonitor(BisonAutofillManager manager) {
            mManager = new WeakReference<BisonAutofillManager>(manager);
        }

        @Override
        public void onAutofillEvent(View view, int virtualId, int event) {
            BisonAutofillManager manager = mManager.get();
    ...
    public BisonAutofillManager(Context context) {
        updateLogStat();
