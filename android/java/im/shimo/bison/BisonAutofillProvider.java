...
public class BisonAutofillProvider extends AutofillProvider {
    ...
    private BisonAutofillManager mAutofillManager;
    private ViewGroup mContainerView;
    private WebContents mWebContents;

    private AutofillRequest mRequest;
    private long mNativeAutofillProvider;
    private BisonAutofillUMA mAutofillUMA;
    private BisonAutofillManager.InputUIObserver mInputUIObserver;
    private long mAutofillTriggeredTimeMillis;

    public BisonAutofillProvider(Context context, ViewGroup containerView) {
        this(containerView, new BisonAutofillManager(context), context);
    }

    @VisibleForTesting
    public BisonAutofillProvider(ViewGroup containerView, BisonAutofillManager manager, Context context) {
        try (ScopedSysTraceEvent e = ScopedSysTraceEvent.scoped("AwAutofillProvider.constructor")) {
            ...
            mAutofillUMA = new BisonAutofillUMA(context);
            mInputUIObserver = new BisonAutofillManager.InputUIObserver() {
                @Override
    ...
    public void onProvideAutoFillVirtualStructure(ViewStructure structure, int flags) {
        ...
        if (BisonAutofillManager.isLoggable()) {
            BisonAutofillManager.log(
    ...
    public void autofill(final SparseArray<AutofillValue> values) {
        if (mNativeAutofillProvider != 0 && mRequest != null && mRequest.autofill((values))) {
            ...
            if (BisonAutofillManager.isLoggable()) {
                BisonAutofillManager.log("autofill values:" + values.size());
            }
