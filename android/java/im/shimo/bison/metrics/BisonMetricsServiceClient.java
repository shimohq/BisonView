...
package im.shimo.bison.metrics;
 ...
 */
@JNINamespace("bison")
public class BisonMetricsServiceClient {
    ...
    public static void setConsentSetting(Context ctx, boolean userConsent) {
        ...
        BisonMetricsServiceClientJni.get().setHaveMetricsConsent(userConsent, !isAppOptedOut(ctx));
    }
