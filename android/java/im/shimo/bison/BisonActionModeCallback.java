 ...
 */
public class BisonActionModeCallback implements ActionMode.Callback {
    private final Context mContext;
    private final BisonContents mAwContents;
    private final ActionModeCallbackHelper mHelper;
    private int mAllowedMenuItems;

    public BisonActionModeCallback(Context context, BisonContents awContents, WebContents webContents) {
        mContext = context;
