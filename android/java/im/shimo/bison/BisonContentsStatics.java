...
import im.shimo.bison.common.PlatformServiceBridge;
 ...
 */
@JNINamespace("bison")
public class BisonContentsStatics {
    ...
    public static void clearClientCertPreferences(Runnable callback) {
        ...
        BisonContentsStaticsJni.get().clearClientCertPreferences(callback);
    }
    ...
    public static String getUnreachableWebDataUrl() {
        ...
        if (sUnreachableWebDataUrl == null) {
            sUnreachableWebDataUrl = BisonContentsStaticsJni.get().getUnreachableWebDataUrl();
        }
    ...
    public static String getProductVersion() {
        return BisonContentsStaticsJni.get().getProductVersion();
    }

    public static void setServiceWorkerIoThreadClient(
            BisonContentsIoThreadClient ioThreadClient, BisonBrowserContext browserContext) {
        BisonContentsStaticsJni.get().setServiceWorkerIoThreadClient(ioThreadClient, browserContext);
    }
    ...
    public static void setSafeBrowsingWhitelist(List<String> urls, Callback<Boolean> callback) {
        ...
        BisonContentsStaticsJni.get().setSafeBrowsingWhitelist(urlArray, callback);
    }
    ...
    public static Uri getSafeBrowsingPrivacyPolicyUrl() {
        return Uri.parse(BisonContentsStaticsJni.get().getSafeBrowsingPrivacyPolicyUrl());
    }

    public static void setCheckClearTextPermitted(boolean permitted) {
        BisonContentsStaticsJni.get().setCheckClearTextPermitted(permitted);
    }

    public static void logCommandLineForDebugging() {
        BisonContentsStaticsJni.get().logCommandLineForDebugging();
    }
    ...
    public static boolean isMultiProcessEnabled() {
        return BisonContentsStaticsJni.get().isMultiProcessEnabled();
    }
