 ...
 */
@JNINamespace("bison")
public class BisonProxyController {
    /**
    ...
    public String setProxyOverride(
        ...
        String result = BisonProxyControllerJni.get().setProxyOverride(
                BisonProxyController.this, urlSchemes, proxyUrls, bypassRules, listener, executor);
        if (result.equals("")) {
    ...
    public String clearProxyOverride(Runnable listener, Executor executor) {
        ...
        BisonProxyControllerJni.get().clearProxyOverride(BisonProxyController.this, listener, executor);
    ...
    @NativeMethods
    interface Natives {
        String setProxyOverride(BisonProxyController caller, String[] urlSchemes, String[] proxyUrls,
                                String[] bypassRules, Runnable listener, Executor executor);
        void clearProxyOverride(BisonProxyController caller, Runnable listener, Executor executor);
    }
}
