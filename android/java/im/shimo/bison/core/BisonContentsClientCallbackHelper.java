 ...
 *
 * Most callbacks do no go through here, but get forwarded to BisonContentsClient directly. The
 * messages processed here may originate from the IO or UI thread.
 */
@VisibleForTesting
public class BisonContentsClientCallbackHelper {
    /**
    ...
    public BisonContentsClientCallbackHelper(Looper looper, BisonContentsClient contentsClient) {
