...
package im.shimo.bison.core.services;
...
public class BisonVariationsSeedFetcher extends JobService {
    private static final String TAG = "BisonVariationsSeedFet-";
    ...
    public static void scheduleIfNeeded() {
        ...
        ComponentName thisComponent = new ComponentName(
                ContextUtils.getApplicationContext(), BisonVariationsSeedFetcher.class);
