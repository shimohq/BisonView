...
public class BisonViewAndroidDelegate extends ViewAndroidDelegate {
    ...
    private final BisonScrollOffsetManager mScrollManager;
    ...
    @VisibleForTesting
    public BisonViewAndroidDelegate(ViewGroup containerView, BisonContentsClient contentsClient,
                                    BisonScrollOffsetManager scrollManager) {
        super(containerView);
