...
package im.shimo.bison.core.common.variations;
...
import im.shimo.bison.core.proto.BisonVariationsSeedOuterClass.BisonVariationsSeed;
...
public class VariationsUtils {
    ...
    public static SeedInfo readSeedFile(File inFile) {
        ...
        try {
            ...
            BisonVariationsSeed proto = null;
            try {
                proto = BisonVariationsSeed.parseFrom(in);
    ...
    public static boolean writeSeed(FileOutputStream out, SeedInfo info) {
        try {
            BisonVariationsSeed proto = BisonVariationsSeed.newBuilder()
