 ...
 */
@JNINamespace("bison")
public class BisonTracingController {
    private static final String TAG = "cr.BisonTracingController";
    ...
    public BisonTracingController() {
        mNativeBisonTracingController = BisonTracingControllerJni.get().init(BisonTracingController.this);
    }
    ...
    public int start(Collection<Integer> predefinedCategories,
        ...
        BisonTracingControllerJni.get().start(
                mNativeBisonTracingController, BisonTracingController.this, categoryFilter, mode);
    ...
    public boolean stopAndFlush(@Nullable OutputStream outputStream) {
        ...
        BisonTracingControllerJni.get().stopAndFlush(
                mNativeBisonTracingController, BisonTracingController.this);
        return true;
    }

    public boolean isTracing() {
        return BisonTracingControllerJni.get().isTracing(
                mNativeBisonTracingController, BisonTracingController.this);
    }
    ...
    private long mNativeBisonTracingController;

    @NativeMethods
    interface Natives {
        long init(BisonTracingController caller);
        boolean start(long nativeBisonTracingController, BisonTracingController caller, String categories,
                      int traceMode);
        boolean stopAndFlush(long nativeBisonTracingController, BisonTracingController caller);
        boolean isTracing(long nativeBisonTracingController, BisonTracingController caller);
    }
}
