 ...
 */
public final class BisonGeolocationPermissions {

    private static final String PREF_PREFIX =
            "BisonGeolocationPermissions%";
    ...
    public BisonGeolocationPermissions(SharedPreferences sharedPreferences) {
    ...
    static void migrateGeolocationPreferences(
        ...
        for (String name : oldPrefs.getAll().keySet()) {
            if (name.startsWith(BisonGeolocationPermissions.PREF_PREFIX)) {
