...
#ifndef BISON_CORE_RENDERER_JS_JAVA_INTERACTION_JS_BINDING_H
#define BISON_CORE_RENDERER_JS_JAVA_INTERACTION_JS_BINDING_H
...
#endif  // BISON_CORE_RENDERER_JS_JAVA_INTERACTION_JS_BINDING_H
