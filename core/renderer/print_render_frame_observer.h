...
#ifndef BISON_CORE_RENDERER_PRINT_RENDER_FRAME_OBSERVER_H_
#define BISON_CORE_RENDERER_PRINT_RENDER_FRAME_OBSERVER_H_
...
#endif  // BISON_CORE_RENDERER_PRINT_RENDER_FRAME_OBSERVER_H_
