...
#ifndef BISON_CORE_RENDERER_BISON_URL_LOADER_THROTTLE_PROVIDER_H_
#define BISON_CORE_RENDERER_BISON_URL_LOADER_THROTTLE_PROVIDER_H_
...
#endif  // BISON_CORE_RENDERER_BISON_URL_LOADER_THROTTLE_PROVIDER_H_
