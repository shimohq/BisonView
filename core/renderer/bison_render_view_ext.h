...
#ifndef BISON_CORE_RENDERER_BISON_RENDER_VIEW_EXT_H_
#define BISON_CORE_RENDERER_BISON_RENDER_VIEW_EXT_H_
...
#endif  // BISON_CORE_RENDERER_BISON_RENDER_VIEW_EXT_H_
