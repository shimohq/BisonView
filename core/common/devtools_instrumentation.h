...
#ifndef BISON_CORE_COMMON_DEVTOOLS_INSTRUMENTATION_H_
#define BISON_CORE_COMMON_DEVTOOLS_INSTRUMENTATION_H_
...
#endif  // BISON_CORE_COMMON_DEVTOOLS_INSTRUMENTATION_H_
