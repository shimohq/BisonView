...
#include "bison/core/browser_jni_headers/BisonContentsClientBridge_jni.h"
#include "bison/core/common/devtools_instrumentation.h"
#include "bison/core/grit/components_strings.h"
...
// BisonContentsClientBridge object does not own and destroy it.
...
// static
BisonContentsClientBridge* BisonContentsClientBridge::FromID(int render_process_id,
                                                       int render_frame_id) {
  DCHECK_CURRENTLY_ON(BrowserThread::UI);
...
BisonContentsClientBridge::BisonContentsClientBridge(JNIEnv* env,
...
BisonContentsClientBridge::~BisonContentsClientBridge() {
  ...
  if (!obj.is_null()) {
    ...
    // it is possible that java object lifetime can exceed the BisonContens.
    Java_BisonContentsClientBridge_setNativeContentsClientBridge(env, obj, 0);
  }
}

void BisonContentsClientBridge::AllowCertificateError(int cert_error,
...
void BisonContentsClientBridge::RunJavaScriptDialog(
  ...
  switch (dialog_type) {
    ...
    case content::JAVASCRIPT_DIALOG_TYPE_PROMPT: {
      ...
      Java_BisonContentsClientBridge_handleJsPrompt(env, obj, jurl, jmessage,
...
bool BisonContentsClientBridge::ShouldOverrideUrlLoading(const base::string16& url,
...
void BisonContentsClientBridge::NewDownload(const GURL& url,
...
void BisonContentsClientBridge::NewLoginRequest(const std::string& realm,
  ...
  Java_BisonContentsClientBridge_newLoginRequest(env, obj, jrealm, jaccount,
                                              jargs);
}
...
void BisonContentsClientBridge::OnSafeBrowsingHit(
    const BisonWebResourceRequest& request,
  ...
  BisonWebResourceRequest::BisonJavaWebResourceRequest java_web_resource_request;
  BisonWebResourceRequest::ConvertToJava(env, request, &java_web_resource_request);
  Java_BisonContentsClientBridge_onSafeBrowsingHit(
      env, obj, java_web_resource_request.jurl, request.is_main_frame,
...
void BisonContentsClientBridge::ConfirmJsResult(JNIEnv* env,
...
void BisonContentsClientBridge::TakeSafeBrowsingAction(JNIEnv*,
                                                    const JavaRef<jobject>&,
                                                    int action,
                                                    bool reporting,
                                                    int request_id) {
  ...
  std::move(*callback).Run(
      static_cast<BisonUrlCheckerDelegateImpl::SafeBrowsingAction>(action),
      reporting);
