...
#ifndef BISON_CORE_BROWSER_BISON_SSL_HOST_STATE_DELEGATE_H_
#define BISON_CORE_BROWSER_BISON_SSL_HOST_STATE_DELEGATE_H_
...
#endif  // BISON_CORE_BROWSER_BISON_SSL_HOST_STATE_DELEGATE_H_
