...
#ifndef BISON_CORE_BROWSER_TRACING_BISON_TRACING_CONTROLLER_H_
#define BISON_CORE_BROWSER_TRACING_BISON_TRACING_CONTROLLER_H_
...
#endif  // BISON_CORE_BROWSER_TRACING_BISON_TRACING_CONTROLLER_H_
