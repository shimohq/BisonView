...
#ifndef BISON_CORE_BROWSER_TRACING_BISON_TRACE_EVENT_ARGS_WHITELIST_H_
#define BISON_CORE_BROWSER_TRACING_BISON_TRACE_EVENT_ARGS_WHITELIST_H_
...
#endif  // BISON_CORE_BROWSER_TRACING_BISON_TRACE_EVENT_ARGS_WHITELIST_H_
