...
class BisonRenderViewHostExtClient {
 public:
 ...
 protected:
  virtual ~BisonRenderViewHostExtClient() {}
};

// Provides RenderViewHost wrapper functionality for sending WebView-specific
// IPC messages to the renderer and from there to WebKit.
class BisonRenderViewHostExt : public content::WebContentsObserver {
 public:
  ...
  BisonRenderViewHostExt(
      BisonRenderViewHostExtClient* client, content::WebContents* contents);
  ~BisonRenderViewHostExt() override;
  ...
  const BisonHitTestData& GetLastHitTestData() const;
 ...
 private:
  ...
  BisonRenderViewHostExtClient* client_;
  ...
  // is called in BisonRenderViewExt.
  BisonHitTestData last_hit_test_data_;
  ...
  DISALLOW_COPY_AND_ASSIGN(BisonRenderViewHostExt);
};
