...
#ifndef BISON_CORE_BROWSER_PERMISSION_BISON_PERMISSION_REQUEST_DELEGATE_H_
#define BISON_CORE_BROWSER_PERMISSION_BISON_PERMISSION_REQUEST_DELEGATE_H_
...
#endif  // BISON_CORE_BROWSER_PERMISSION_BISON_PERMISSION_REQUEST_DELEGATE_H_
