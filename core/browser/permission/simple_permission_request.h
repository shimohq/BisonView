...
#ifndef BISON_CORE_BROWSER_PERMISSION_SIMPLE_PERMISSION_REQUEST_H_
#define BISON_CORE_BROWSER_PERMISSION_SIMPLE_PERMISSION_REQUEST_H_
...
#endif  // BISON_CORE_BROWSER_PERMISSION_SIMPLE_PERMISSION_REQUEST_H_
