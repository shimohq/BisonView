...
#ifndef BISON_CORE_BROWSER_PERMISSION_PERMISSION_REQUEST_HANDLER_CLIENT_H_
#define BISON_CORE_BROWSER_PERMISSION_PERMISSION_REQUEST_HANDLER_CLIENT_H_
...
#endif  // BISON_CORE_BROWSER_PERMISSION_PERMISSION_REQUEST_HANDLER_CLIENT_H_
