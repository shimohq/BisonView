...
#ifndef BISON_CORE_BROWSER_BISON_DEVTOOLS_MANAGER_DELEGATE_H_
#define BISON_CORE_BROWSER_BISON_DEVTOOLS_MANAGER_DELEGATE_H_
...
#endif  // BISON_CORE_BROWSER_BISON_DEVTOOLS_MANAGER_DELEGATE_H_
