...
#ifndef BISON_CORE_BROWSER_GFX_PARENT_COMPOSITOR_DRAW_CONSTRAINTS_H_
#define BISON_CORE_BROWSER_GFX_PARENT_COMPOSITOR_DRAW_CONSTRAINTS_H_
...
#endif  // BISON_CORE_BROWSER_GFX_PARENT_COMPOSITOR_DRAW_CONSTRAINTS_H_
