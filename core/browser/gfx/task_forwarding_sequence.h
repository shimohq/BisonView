...
#ifndef BISON_CORE_BROWSER_GFX_TASK_FORWARDING_SEQUENCE_H_
#define BISON_CORE_BROWSER_GFX_TASK_FORWARDING_SEQUENCE_H_
...
#endif  // BISON_CORE_BROWSER_GFX_TASK_FORWARDING_SEQUENCE_H_
