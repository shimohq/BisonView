...
#include "bison/core/browser_jni_headers/JavaBrowserViewRendererHelper_jni.h"
#include "bison/core/public/browser/draw_sw.h"
...
BisonDrawSWFunctionTable* g_sw_draw_functions = NULL;
