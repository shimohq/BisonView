...
#ifndef BISON_CORE_BROWSER_GFX_ROOT_FRAME_SINK_PROXY_H_
#define BISON_CORE_BROWSER_GFX_ROOT_FRAME_SINK_PROXY_H_
...
#endif  // BISON_CORE_BROWSER_GFX_ROOT_FRAME_SINK_PROXY_H_
