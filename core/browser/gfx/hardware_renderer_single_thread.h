...
#ifndef BISON_CORE_BROWSER_GFX_HARDWARE_RENDERER_SINGLE_THREAD_H_
#define BISON_CORE_BROWSER_GFX_HARDWARE_RENDERER_SINGLE_THREAD_H_
...
#endif  // BISON_CORE_BROWSER_GFX_HARDWARE_RENDERER_SINGLE_THREAD_H_
