...
#include "bison/core/browser/gfx/bison_draw_fn_impl.h"

#include <utility>

#include "bison/core/browser/gfx/bison_vulkan_context_provider.h"
#include "bison/core/browser_jni_headers/BisonDrawFnImpl_jni.h"
#include "bison/core/common/bison_switches.h"
#include "bison/core/public/browser/draw_gl.h"
...
BisonDrawFnFunctionTable* g_draw_fn_function_table = nullptr;

void OnSyncWrapper(int functor, void* data, BisonDrawFn_OnSyncParams* params) {
  TRACE_EVENT1("bison,toplevel", "DrawFn_OnSync", "functor", functor);
  CHECK_EQ(static_cast<BisonDrawFnImpl*>(data)->functor_handle(), functor);
  static_cast<BisonDrawFnImpl*>(data)->OnSync(params);
}

void OnContextDestroyedWrapper(int functor, void* data) {
  TRACE_EVENT1("bison,toplevel", "DrawFn_OnContextDestroyed",
               "functor", functor);
  CHECK_EQ(static_cast<BisonDrawFnImpl*>(data)->functor_handle(), functor);
  static_cast<BisonDrawFnImpl*>(data)->OnContextDestroyed();
}

void OnDestroyedWrapper(int functor, void* data) {
  TRACE_EVENT1("bison,toplevel", "DrawFn_OnDestroyed", "functor",
               functor);
  CHECK_EQ(static_cast<BisonDrawFnImpl*>(data)->functor_handle(), functor);
  delete static_cast<BisonDrawFnImpl*>(data);
}

void DrawGLWrapper(int functor, void* data, BisonDrawFn_DrawGLParams* params) {
  TRACE_EVENT1("bison,toplevel", "DrawFn_DrawGL", "functor", functor);
  CHECK_EQ(static_cast<BisonDrawFnImpl*>(data)->functor_handle(), functor);
  static_cast<BisonDrawFnImpl*>(data)->DrawGL(params);
}

void InitVkWrapper(int functor, void* data, BisonDrawFn_InitVkParams* params) {
  TRACE_EVENT1("bison,toplevel", "DrawFn_InitVk", "functor", functor);
  CHECK_EQ(static_cast<BisonDrawFnImpl*>(data)->functor_handle(), functor);
  static_cast<BisonDrawFnImpl*>(data)->InitVk(params);
}

void DrawVkWrapper(int functor, void* data, BisonDrawFn_DrawVkParams* params) {
  TRACE_EVENT1("bison,toplevel", "DrawFn_DrawVk", "functor", functor);
  CHECK_EQ(static_cast<BisonDrawFnImpl*>(data)->functor_handle(), functor);
  static_cast<BisonDrawFnImpl*>(data)->DrawVk(params);
}

void PostDrawVkWrapper(int functor,
                       void* data,
                       BisonDrawFn_PostDrawVkParams* params) {
  TRACE_EVENT1("bison,toplevel", "DrawFn_PostDrawVk", "functor",
               functor);
  CHECK_EQ(static_cast<BisonDrawFnImpl*>(data)->functor_handle(), functor);
  static_cast<BisonDrawFnImpl*>(data)->PostDrawVk(params);
}

sk_sp<GrVkSecondaryCBDrawContext> CreateDrawContext(
    GrContext* gr_context,
    BisonDrawFn_DrawVkParams* params,
...
static void JNI_BisonDrawFnImpl_SetDrawFnFunctionTable(JNIEnv* env,
                                                    jlong function_table) {
  g_draw_fn_function_table =
      reinterpret_cast<BisonDrawFnFunctionTable*>(function_table);
}

BisonDrawFnImpl::BisonDrawFnImpl()
  ...
  static BisonDrawFnFunctorCallbacks g_functor_callbacks{
...
void BisonDrawFnImpl::ReleaseHandle(
    JNIEnv* env,
...
jint BisonDrawFnImpl::GetFunctorHandle(
    JNIEnv* env,
    const base::android::JavaParamRef<jobject>& obj) {
  DCHECK_CURRENTLY_ON(BrowserThread::UI);
...
jlong BisonDrawFnImpl::GetCompositorFrameConsumer(
    JNIEnv* env,
    const base::android::JavaParamRef<jobject>& obj) {
  DCHECK_CURRENTLY_ON(BrowserThread::UI);
...
static jlong JNI_BisonDrawFnImpl_Create(JNIEnv* env) {
  DCHECK_CURRENTLY_ON(BrowserThread::UI);
  return reinterpret_cast<intptr_t>(new BisonDrawFnImpl());
}

void BisonDrawFnImpl::OnSync(BisonDrawFn_OnSyncParams* params) {
  render_thread_manager_.UpdateViewTreeForceDarkStateOnRT(
      params->apply_force_dark);
  render_thread_manager_.CommitFrameOnRT();
}

void BisonDrawFnImpl::OnContextDestroyed() {
...
void BisonDrawFnImpl::DrawGL(BisonDrawFn_DrawGLParams* params) {
  auto color_space = params->version >= 2 ? CreateColorSpace(params) : nullptr;
  DrawInternal(params, color_space.get());
}

void BisonDrawFnImpl::InitVk(BisonDrawFn_InitVkParams* params) {
  ...
  vulkan_context_provider_ =
      BisonVulkanContextProvider::GetOrCreateInstance(params);
...
void BisonDrawFnImpl::DrawVk(BisonDrawFn_DrawVkParams* params) {
  if (is_interop_mode_) {
...
void BisonDrawFnImpl::PostDrawVk(BisonDrawFn_PostDrawVkParams* params) {
  if (is_interop_mode_) {
...
void BisonDrawFnImpl::DrawVkDirect(BisonDrawFn_DrawVkParams* params) {
...
void BisonDrawFnImpl::PostDrawVkDirect(BisonDrawFn_PostDrawVkParams* params) {
  if (!vulkan_context_provider_)
    return;
...
void BisonDrawFnImpl::DrawVkInterop(BisonDrawFn_DrawVkParams* params) {
...
void BisonDrawFnImpl::PostDrawVkInterop(BisonDrawFn_PostDrawVkParams* params) {
  // Use a temporary to automatically clean up if we hit a failure case.
...
template <typename T>
void BisonDrawFnImpl::DrawInternal(T* params, SkColorSpace* color_space) {
...
BisonDrawFnImpl::InFlightInteropDraw::InFlightInteropDraw(
