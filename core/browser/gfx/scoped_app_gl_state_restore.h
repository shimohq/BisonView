...
#ifndef BISON_CORE_BROWSER_GFX_SCOPED_APP_GL_STATE_RESTORE_H_
#define BISON_CORE_BROWSER_GFX_SCOPED_APP_GL_STATE_RESTORE_H_
...
#endif  // BISON_CORE_BROWSER_GFX_SCOPED_APP_GL_STATE_RESTORE_H_
