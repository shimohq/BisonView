...
#ifndef BISON_CORE_BROWSER_GFX_TASK_QUEUE_WEB_VIEW_H_
#define BISON_CORE_BROWSER_GFX_TASK_QUEUE_WEB_VIEW_H_
...
#endif  // BISON_CORE_BROWSER_GFX_TASK_QUEUE_WEB_VIEW_H_
