...
#ifndef BISON_CORE_BROWSER_GFX_COMPOSITOR_FRAME_CONSUMER_H_
#define BISON_CORE_BROWSER_GFX_COMPOSITOR_FRAME_CONSUMER_H_
...
#endif  // BISON_CORE_BROWSER_GFX_COMPOSITOR_FRAME_CONSUMER_H_
