...
#ifndef BISON_CORE_BROWSER_GFX_PARENT_OUTPUT_SURFACE_H_
#define BISON_CORE_BROWSER_GFX_PARENT_OUTPUT_SURFACE_H_
...
#endif  // BISON_CORE_BROWSER_GFX_PARENT_OUTPUT_SURFACE_H_
