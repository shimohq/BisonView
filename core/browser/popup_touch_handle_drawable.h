...
#ifndef BISON_CORE_BROWSER_POPUP_TOUCH_HANDLE_DRAWABLE_H_
#define BISON_CORE_BROWSER_POPUP_TOUCH_HANDLE_DRAWABLE_H_
...
#endif  // BISON_CORE_BROWSER_POPUP_TOUCH_HANDLE_DRAWABLE_H_
