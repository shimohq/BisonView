...
#ifndef BISON_CORE_BROWSER_BISON_CONTENT_BROWSER_OVERLAY_MANIFEST_H_
#define BISON_CORE_BROWSER_BISON_CONTENT_BROWSER_OVERLAY_MANIFEST_H_
...
#endif  // BISON_CORE_BROWSER_BISON_CONTENT_BROWSER_OVERLAY_MANIFEST_H_
