...
#ifndef BISON_CORE_BROWSER_BISON_BROWSER_TERMINATOR_H_
#define BISON_CORE_BROWSER_BISON_BROWSER_TERMINATOR_H_
...
#endif  // BISON_CORE_BROWSER_BISON_BROWSER_TERMINATOR_H_
