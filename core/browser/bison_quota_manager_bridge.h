...
#ifndef BISON_CORE_BROWSER_BISON_QUOTA_MANAGER_BRIDGE_H_
#define BISON_CORE_BROWSER_BISON_QUOTA_MANAGER_BRIDGE_H_
...
#endif  // BISON_CORE_BROWSER_BISON_QUOTA_MANAGER_BRIDGE_H_
