...
#ifndef BISON_CORE_BROWSER_BISON_FEATURE_LIST_CREATOR_H_
#define BISON_CORE_BROWSER_BISON_FEATURE_LIST_CREATOR_H_

#include <memory>

#include "bison/core/browser/bison_browser_policy_connector.h"
#include "bison/core/browser/bison_field_trials.h"
#include "bison/core/browser/bison_variations_service_client.h"
...
class BisonFeatureListCreator {
 public:
  ...
  std::unique_ptr<BisonBrowserPolicyConnector> TakeBrowserPolicyConnector() {
 ...
 private:
  ...
  std::unique_ptr<BisonFieldTrials> aw_field_trials_;
  ...
  DISALLOW_COPY_AND_ASSIGN(BisonFeatureListCreator);
};

}  // namespace bison

#endif  // BISON_CORE_BROWSER_BISON_FEATURE_LIST_CREATOR_H_
