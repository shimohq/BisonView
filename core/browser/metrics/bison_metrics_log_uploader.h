...
#ifndef BISON_CORE_BROWSER_METRICS_BISON_METRICS_LOG_UPLOADER_H_
#define BISON_CORE_BROWSER_METRICS_BISON_METRICS_LOG_UPLOADER_H_
...
#endif  // BISON_CORE_BROWSER_METRICS_BISON_METRICS_LOG_UPLOADER_H_
