...
#ifndef BISON_CORE_BROWSER_NETWORK_SERVICE_ANDROID_STREAM_READER_URL_LOADER_H_
#define BISON_CORE_BROWSER_NETWORK_SERVICE_ANDROID_STREAM_READER_URL_LOADER_H_
...
#endif  // BISON_CORE_BROWSER_NETWORK_SERVICE_ANDROID_STREAM_READER_URL_LOADER_H_
