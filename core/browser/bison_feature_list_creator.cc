...
#include "bison/core/browser/bison_pref_names.h"
#include "bison/core/browser/bison_variations_seed_bridge.h"
...
BisonFeatureListCreator::BisonFeatureListCreator()
    : aw_field_trials_(std::make_unique<BisonFieldTrials>()) {}
...
void BisonFeatureListCreator::CreateLocalState() {
  browser_policy_connector_ = std::make_unique<BisonBrowserPolicyConnector>();
