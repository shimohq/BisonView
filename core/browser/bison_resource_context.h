...
#ifndef BISON_CORE_BROWSER_BISON_RESOURCE_CONTEXT_H_
#define BISON_CORE_BROWSER_BISON_RESOURCE_CONTEXT_H_
...
#endif  // BISON_CORE_BROWSER_BISON_RESOURCE_CONTEXT_H_
