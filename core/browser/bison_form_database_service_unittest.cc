...
class BisonFormDatabaseServiceTest : public Test {
 public:
  BisonFormDatabaseServiceTest() {}
 ...
 protected:
  void SetUp() override {
    ...
    service_.reset(new BisonFormDatabaseService(temp_dir_.GetPath()));
  }
  ...
  JNIEnv* env_;
  std::unique_ptr<BisonFormDatabaseService> service_;
};

TEST_F(BisonFormDatabaseServiceTest, HasAndClearFormData) {
