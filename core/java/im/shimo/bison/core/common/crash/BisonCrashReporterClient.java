...
package im.shimo.bison.core.common.crash;
 ...
 */
@JNINamespace("bison")
public class BisonCrashReporterClient {
    /**
    ...
    public static boolean stackTraceContainsWebViewCode(Throwable t) {
        ClassLoader webViewClassLoader = BisonCrashReporterClient.class.getClassLoader();
