...
#ifndef BISON_COMMON_RENDER_VIEW_MESSAGES_H_
#define BISON_COMMON_RENDER_VIEW_MESSAGES_H_
...
#define IPC_MESSAGE_START BisonViewMsgStart
...
IPC_MESSAGE_CONTROL0(BisonViewMsg_ClearCache)

// Tells render process to kill itself (only for testing).
IPC_MESSAGE_CONTROL0(BisonViewMsg_KillProcess)
...
IPC_MESSAGE_ROUTED1(BisonViewMsg_DocumentHasImages, uint32_t /* id */)
...
IPC_MESSAGE_ROUTED2(BisonViewMsg_DoHitTest,
                    gfx::PointF /* touch_center */,
                    gfx::SizeF /* touch_area */)

// Sets the zoom factor for text only. Used in layout modes other than
// Text Autosizing.
IPC_MESSAGE_ROUTED1(BisonViewMsg_SetTextZoomFactor, float /* zoom_factor */)
...
IPC_MESSAGE_ROUTED0(BisonViewMsg_ResetScrollAndScaleState)

// Sets the initial page scale. This overrides initial scale set by
// the meta viewport tag.
IPC_MESSAGE_ROUTED1(BisonViewMsg_SetInitialPageScale,
                    double /* page_scale_factor */)

// Sets the base background color for this view.
IPC_MESSAGE_ROUTED1(BisonViewMsg_SetBackgroundColor, SkColor)

IPC_MESSAGE_CONTROL1(BisonViewMsg_SetJsOnlineProperty, bool /* network_up */)

// Tells blink to smooth scroll to the specified location within |duration_ms|.
IPC_MESSAGE_ROUTED3(BisonViewMsg_SmoothScroll,
                    int /* target_x */,
                    int /* target_y */,
...
// not.
IPC_MESSAGE_ROUTED1(BisonViewMsg_WillSuppressErrorPage,
...
// Response to BisonViewMsg_DocumentHasImages request.
IPC_MESSAGE_ROUTED2(BisonViewHostMsg_DocumentHasImagesResponse,
                    int, /* id */
                    bool /* has_images */)
...
IPC_SYNC_MESSAGE_CONTROL5_1(BisonViewHostMsg_ShouldOverrideUrlLoading,
...
IPC_MESSAGE_CONTROL2(BisonViewHostMsg_SubFrameCreated,
