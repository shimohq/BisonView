...
#include "bison/bison_jni_headers/BvContentsBackgroundThreadClient_jni.h"
#include "bison/bison_jni_headers/BvContentsIoThreadClient_jni.h"
...
BvContentsIoThreadClient::FromID(int render_process_id,
                                    int render_frame_id) {
  ...
  return std::make_unique<BvContentsIoThreadClient>(
      client_data.pending_association, java_delegate);
}

std::unique_ptr<BvContentsIoThreadClient>
BvContentsIoThreadClient::FromID(int frame_tree_node_id) {
  IoThreadClientData client_data;
...
// static
void BvContentsIoThreadClient::SubFrameCreated(int render_process_id,
...
// static
void BvContentsIoThreadClient::RegisterPendingContents(
    WebContents* web_contents) {
  IoThreadClientData client_data;
...
// static
void BvContentsIoThreadClient::Associate(WebContents* web_contents,
...
// static
void BvContentsIoThreadClient::SetServiceWorkerIoThreadClient(
...
// static
std::unique_ptr<BvContentsIoThreadClient>
BvContentsIoThreadClient::GetServiceWorkerIoThreadClient() {
  JNIEnv* env = AttachCurrentThread();
  ...
  return std::make_unique<BvContentsIoThreadClient>(false, java_delegate);
}

BvContentsIoThreadClient::BvContentsIoThreadClient(
    bool pending_association,
    const JavaRef<jobject>& obj)
    : pending_association_(pending_association), java_object_(obj) {}

BvContentsIoThreadClient::~BvContentsIoThreadClient() = default;

bool BvContentsIoThreadClient::PendingAssociation() const {
  return pending_association_;
}

BvContentsIoThreadClient::CacheMode
BvContentsIoThreadClient::GetCacheMode() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return BvContentsIoThreadClient::LOAD_DEFAULT;

  JNIEnv* env = AttachCurrentThread();
  return static_cast<BvContentsIoThreadClient::CacheMode>(
      Java_BvContentsIoThreadClient_getCacheMode(env, java_object_));
}
...
void RecordInterceptedScheme(bool response_is_null, const std::string& url) {
  ...
  UMA_HISTOGRAM_ENUMERATION("BisonView.ShouldInterceptRequest.InterceptionType",
                            type);
}
...
void RecordResponseStatusCode(
    JNIEnv* env,
    const std::unique_ptr<BvWebResourceResponse>& response) {
  DCHECK(response);
...
std::unique_ptr<BisonWebResourceInterceptResponse> RunShouldInterceptRequest(
  ...
  ScopedJavaLocalRef<jobject> ret =
      Java_BvContentsBackgroundThreadClient_shouldInterceptRequestFromNative(
...
void BvContentsIoThreadClient::ShouldInterceptRequestAsync(
  ...
  if (bg_thread_client_object_.is_null() && !java_object_.is_null()) {
    bg_thread_client_object_.Reset(
        Java_BvContentsIoThreadClient_getBackgroundThreadClient(
            env, java_object_));
  }
...
bool BvContentsIoThreadClient::ShouldBlockContentUrls() const {
  ...
  JNIEnv* env = AttachCurrentThread();
  return Java_BvContentsIoThreadClient_shouldBlockContentUrls(env,
                                                                 java_object_);
}

bool BvContentsIoThreadClient::ShouldBlockFileUrls() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BvContentsIoThreadClient_shouldBlockFileUrls(env,
                                                              java_object_);
}

bool BvContentsIoThreadClient::ShouldAcceptThirdPartyCookies() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BvContentsIoThreadClient_shouldAcceptThirdPartyCookies(
      env, java_object_);
}

bool BvContentsIoThreadClient::GetSafeBrowsingEnabled() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BvContentsIoThreadClient_getSafeBrowsingEnabled(env,
                                                                 java_object_);
}

bool BvContentsIoThreadClient::ShouldBlockNetworkLoads() const {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
  if (java_object_.is_null())
    return false;

  JNIEnv* env = AttachCurrentThread();
  return Java_BvContentsIoThreadClient_shouldBlockNetworkLoads(env,
                                                                  java_object_);
}
