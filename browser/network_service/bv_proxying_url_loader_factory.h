...
#ifndef BISON_BROWSER_NETWORK_SERVICE_BV_PROXYING_URL_LOADER_FACTORY_H_
#define BISON_BROWSER_NETWORK_SERVICE_BV_PROXYING_URL_LOADER_FACTORY_H_
...
//  on the UI thread.
//
class BvProxyingURLLoaderFactory : public network::mojom::URLLoaderFactory {
 public:
  ...
  BvProxyingURLLoaderFactory(const BvProxyingURLLoaderFactory&) = delete;
  BvProxyingURLLoaderFactory& operator=(const BvProxyingURLLoaderFactory&) =
      delete;

  ~BvProxyingURLLoaderFactory() override;
 ...
 private:
  ...
  base::WeakPtrFactory<BvProxyingURLLoaderFactory> weak_factory_{this};
};

}  // namespace bison

#endif  // BISON_BROWSER_NETWORK_SERVICE_BV_PROXYING_URL_LOADER_FACTORY_H_
