...
#ifndef BISON_BROWSER_NETWORK_SERVICE_BV_WEB_RESOURCE_RESPONSE_H_
#define BISON_BROWSER_NETWORK_SERVICE_BV_WEB_RESOURCE_RESPONSE_H_
...
#endif  // BISON_BROWSER_NETWORK_SERVICE_BV_WEB_RESOURCE_RESPONSE_H_
