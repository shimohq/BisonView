...
BvProxyConfigMonitor::BvProxyConfigMonitor() {
...
BvProxyConfigMonitor* BvProxyConfigMonitor::GetInstance() {
  static base::NoDestructor<BvProxyConfigMonitor> instance;
  return instance.get();
}

void BvProxyConfigMonitor::AddProxyToNetworkContextParams(
...
void BvProxyConfigMonitor::OnProxyConfigChanged(
...
std::string BvProxyConfigMonitor::SetProxyOverride(
  ...
  return proxy_config_service_android_->SetProxyOverride(
      ...
      base::BindOnce(&BvProxyConfigMonitor::FlushProxyConfig,
                     base::Unretained(this), std::move(callback)));
}

void BvProxyConfigMonitor::ClearProxyOverride(base::OnceClosure callback) {
  proxy_config_service_android_->ClearProxyOverride(
      base::BindOnce(&BvProxyConfigMonitor::FlushProxyConfig,
                     base::Unretained(this), std::move(callback)));
}

void BvProxyConfigMonitor::FlushProxyConfig(base::OnceClosure callback) {
