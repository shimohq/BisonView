...
BisonContentsIoThreadClient::FromID(int render_process_id,
                                    int render_frame_id) {
...
std::unique_ptr<BisonContentsIoThreadClient>
BisonContentsIoThreadClient::FromID(int frame_tree_node_id) {
  IoThreadClientData client_data;
...
BisonContentsIoThreadClient::CacheMode
BisonContentsIoThreadClient::GetCacheMode() const {
...
bool BisonContentsIoThreadClient::ShouldBlockFileUrls() const {
  ...
  JNIEnv* env = AttachCurrentThread();
  return Java_BisonContentsIoThreadClient_shouldBlockFileUrls(env,
                                                              java_object_);
}
