...
#include "bison/bison_jni_headers/BisonQuotaManagerBridge_jni.h"
...
void BisonQuotaManagerBridge::DeleteAllData(
    JNIEnv* env,
    const JavaParamRef<jobject>& object) {
  RunOnUIThread(
...
void BisonQuotaManagerBridge::DeleteOrigin(
    JNIEnv* env,
    const JavaParamRef<jobject>& object,
...
void BisonQuotaManagerBridge::GetUsageAndQuotaForOrigin(
  ...
  RunOnUIThread(base::BindOnce(
      &BisonQuotaManagerBridge::GetUsageAndQuotaForOriginOnUiThread, this,
