...
BvFormDatabaseService::BvFormDatabaseService(const base::FilePath path)
...
BvFormDatabaseService::~BvFormDatabaseService() {
  Shutdown();
}

void BvFormDatabaseService::Shutdown() {
...
BvFormDatabaseService::get_autofill_webdata_service() {
  return autofill_data_;
}

void BvFormDatabaseService::ClearFormData() {
  base::Time begin;
...
bool BvFormDatabaseService::HasFormData() {
  has_form_data_result_ = false;
...
void BvFormDatabaseService::OnWebDataServiceRequestDone(
