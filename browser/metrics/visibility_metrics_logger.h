#ifndef BISON_BROWSER_METRICS_VISIBILITY_METRICS_LOGGER_H_
#define BISON_BROWSER_METRICS_VISIBILITY_METRICS_LOGGER_H_
...
#endif  // BISON_BROWSER_METRICS_VISIBILITY_METRICS_LOGGER_H_
