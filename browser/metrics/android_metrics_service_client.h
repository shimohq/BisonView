...
#ifndef BISON_BROWSER_METRICS_ANDROID_METRICS_SERVICE_CLIENT_H_
#define BISON_BROWSER_METRICS_ANDROID_METRICS_SERVICE_CLIENT_H_
...
#endif  // BISON_BROWSER_METRICS_ANDROID_METRICS_SERVICE_CLIENT_H_
