...
class BvBrowserPermissionRequestDelegateForTesting final
...
class BvPermissionManagerForTesting : public BvPermissionManager {
 public:
  ~BvPermissionManagerForTesting() override {
 ...
 private:
  BvBrowserPermissionRequestDelegateForTesting* delegate() {
    if (!delegate_)
      delegate_.reset(new BvBrowserPermissionRequestDelegateForTesting);
  ...
  BvBrowserPermissionRequestDelegate* GetDelegate(
  ...
  std::unique_ptr<BvBrowserPermissionRequestDelegateForTesting> delegate_;
};
...
class AwPermissionManagerTest : public testing::Test {
 ...
 protected:
  void SetUp() override { manager.reset(new BvPermissionManagerForTesting); }
  ...
  std::unique_ptr<BvPermissionManagerForTesting> manager;

  // Use nullptr for testing. BvPermissionManagerForTesting override all methods
