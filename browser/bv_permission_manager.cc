...
BvPermissionManager::BvPermissionManager()
...
void BvPermissionManager::RequestPermissions(
  ...
  BvBrowserPermissionRequestDelegate* delegate =
...
// static
void BvPermissionManager::OnRequestResponse(
...
void BvPermissionManager::ResetPermission(PermissionType permission,
                                          const GURL& requesting_origin,
                                          const GURL& embedding_origin) {
...
void BvPermissionManager::CancelPermissionRequest(int request_id) {
  ...
  BvBrowserPermissionRequestDelegate* delegate = GetDelegate(
...
void BvPermissionManager::CancelPermissionRequests() {
...
int BvPermissionManager::GetRenderProcessID(
    content::RenderFrameHost* render_frame_host) {
  return render_frame_host->GetProcess()->GetID();
}

int BvPermissionManager::GetRenderFrameID(
    content::RenderFrameHost* render_frame_host) {
...
BvBrowserPermissionRequestDelegate* BvPermissionManager::GetDelegate(
  ...
  return BvBrowserPermissionRequestDelegate::FromID(render_process_id,
                                                    render_frame_id);
}
