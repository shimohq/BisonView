...
class BvRenderViewHostExt : public content::WebContentsObserver {
 public:
  ...
  BvRenderViewHostExt(BisonRenderViewHostExtClient* client,
  ...
  const BvHitTestData& GetLastHitTestData() const;
 ...
 private:
  ...
  BvHitTestData last_hit_test_data_;
  ...
  DISALLOW_COPY_AND_ASSIGN(BvRenderViewHostExt);
};
