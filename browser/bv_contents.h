...
class BvContents : public FindHelper::Listener,
                   ...
                   public BvRenderViewHostExtClient,
 ...
 public:
  ...
  BvContents(std::unique_ptr<content::WebContents> web_contents);

  BvContents(const BvContents&) = delete;
  BvContents& operator=(const BvContents&) = delete;
  ...
  // BvRenderViewHostExtClient implementation.
  ...
  void OnViewTreeForceDarkStateChanged(bool view_tree_force_dark_state);
 ...
 private:
  ...
  std::unique_ptr<BvContents> pending_contents_;
