...
#include "bison/test/bison_view_unittests_jni/MockBvContentsClientBridge_jni.h"
...
// Tests the bison_view contents client bridge.
class BvContentsClientBridgeTest : public Test {
 public:
  BvContentsClientBridgeTest() {}
 ...
 protected:
  ...
  std::unique_ptr<BvContentsClientBridge> bridge_;
...
class TestClientCertificateDelegate
 ...
 public:
  explicit TestClientCertificateDelegate(BvContentsClientBridgeTest* test)
      : test_(test) {}
 ...
 private:
  BvContentsClientBridgeTest* test_;
...
void BvContentsClientBridgeTest::SetUp() {
  env_ = AttachCurrentThread();
  ASSERT_THAT(env_, NotNull());
  jbridge_.Reset(
      env_,
      Java_MockBvContentsClientBridge_getBvContentsClientBridge(env_).obj());
  bridge_.reset(new BvContentsClientBridge(env_, jbridge_));
  selected_cert_ = nullptr;
  cert_selected_callbacks_ = 0;
  cert_request_info_ = base::MakeRefCounted<net::SSLCertRequestInfo>();
}

void BvContentsClientBridgeTest::CertSelected(
...
TEST_F(BvContentsClientBridgeTest, TestClientCertKeyTypesCorrectlyEncoded) {
...
void BvContentsClientBridgeTest::TestCertType(
  ...
  ScopedJavaLocalRef<jobjectArray> key_types =
      Java_MockBvContentsClientBridge_getKeyTypes(env_, jbridge_);
...
TEST_F(BvContentsClientBridgeTest,
  ...
  bridge_->ProvideClientCertificateResponse(
      env_, jbridge_,
      Java_MockBvContentsClientBridge_getRequestId(env_, jbridge_),
      Java_MockBvContentsClientBridge_createTestCertChain(env_, jbridge_),
      nullptr);
  base::RunLoop().RunUntilIdle();
...
TEST_F(BvContentsClientBridgeTest,
  ...
  bridge_->SelectClientCertificate(
      cert_request_info_.get(),
      base::WrapUnique(new TestClientCertificateDelegate(this)));
  int requestId = Java_MockBvContentsClientBridge_getRequestId(env_, jbridge_);
