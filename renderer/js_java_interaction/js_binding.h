...
#ifndef BISON_RENDERER_JS_JAVA_INTERACTION_JS_BINDING_H_
#define BISON_RENDERER_JS_JAVA_INTERACTION_JS_BINDING_H_
...
#endif  // BISON_RENDERER_JS_JAVA_INTERACTION_JS_BINDING_H_
